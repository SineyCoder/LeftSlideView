package com.frz.slidepickerview;
...
public class SlidePickerView extends View {
    ...
    public SlidePickerView(Context context) {
        this(context, null);
    }

    public SlidePickerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.EasyPickerView, defStyleAttr, 0);
        textSize = a.getDimensionPixelSize(R.styleable.EasyPickerView_textSize, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 16, getResources().getDisplayMetrics()));
        textColor = a.getColor(R.styleable.EasyPickerView_textColor, Color.rgb(235, 170, 114));
        textPadding = a.getDimensionPixelSize(R.styleable.EasyPickerView_textPadding, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()));
        textMaxScale = a.getFloat(R.styleable.EasyPickerView_textMaxScale, 2.0f);
        textMinAlpha = a.getFloat(R.styleable.EasyPickerView_textMinAlpha, 0.4f);
        isRecycleMode = a.getBoolean(R.styleable.EasyPickerView_recycleMode, true);
        maxShowNum = a.getInteger(R.styleable.EasyPickerView_maxShowNum, 3);
        doubleLine = a.getBoolean(R.styleable.EasyPickerView_doubleLine, true);
        lineWidth = a.getInteger(R.styleable.EasyPickerView_lineWidth, 2);
        lineColor = a.getColor(R.styleable.EasyPickerView_lineColor, Color.rgb(175, 30, 127));
    ...
    protected void onDraw(Canvas canvas) {
        if (null != dataList && dataList.size() > 0) {
            ...
            if(doubleLine){
                int topLine = textHeight + textPadding;
                int bottomLine = contentHeight - topLine;
                canvas.drawLine(0, topLine, contentWidth, topLine, paint);
                canvas.drawLine(0, bottomLine, contentWidth, bottomLine, paint);
            }
//            Log.d("TAG", contentWidth+","+contentHeight + ","+textHeight+","+textPadding);
        }
    }
